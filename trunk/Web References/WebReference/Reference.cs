...
namespace ehl.itgs.uploaddata.WebReference {
    using System;
    ...
    [System.Web.Services.WebServiceBindingAttribute(Name="RmOutAccessSoapBinding", Namespace="http://localhost:8080/rmweb/services/RmOutAccess")]
    public partial class RmJaxRpcOutAccessService : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public RmJaxRpcOutAccessService() {
            this.Url = global::ehl.itgs.uploaddata.Properties.Settings.Default.ehl_itgs_uploaddata_WebReference_RmJaxRpcOutAccessService;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("", RequestNamespace="http://endpoint.axis.rm.tmri.com", ResponseNamespace="http://localhost:8080/rmweb/services/RmOutAccess")]
